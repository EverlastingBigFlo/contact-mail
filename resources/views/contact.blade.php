            ...
            <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
                <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                    <div class="text-white lg:w-1/2 lg:mx-6">
                        <h1 class="text-2xl font-semibold capitalize lg:text-5xl">Everlasting tech solution</h1>
                        ...
                        <button
                            class="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md hover:bg-black focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                            get in touch
                        </button>
                    ...
                    <div class="mt-8 lg:w-1/2 lg:mx-6">
                        <div
                            class="w-full px-8 py-10 mx-auto overflow-hidden bg-black shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                            <h1 class="text-3xl font-medium text-white dark:text-gray-200">Contact form</h1>
                            ...
                            <form action="{{ route('')}}" class="mt-6">
                                ...
                                <div class="flex-1 mt-6">
                                    ...
                                    <input type="email" value="{{old('email')}}" placeholder="Please fill in your email"
                                        class="block w-full px-5 py-3 mt-2 text-gray-700 bg-transparent border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                    <small style="color: red">
                                            @error('email')
                                                {{$message}}
                                ...
                                <button type="submit"
                                    class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                                    get in touch
                                </button>
                            </form>
                        </div>
